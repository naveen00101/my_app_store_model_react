...
class AppStore extends Component {
  ...
  render() {
    ...
    const results = appList.filter(eachItem =>
      eachItem.appName.toUpperCase().includes(searchText.toUpperCase()),
    )
      ...
      <div className="bg-container">
          ...
          <ul className="tabList-container">
            {tabsList.map(eachItem => (
              <TabItem
                ...
                active={activeTab === eachItem.tabId}
                key={eachItem.tabId}
              />
            ))}
          </ul>
        ...
        <ul className="app-container">
          {results.map(eachItem => (
            <AppItem item={eachItem} key={eachItem.appId} />
          ))}
        </ul>
      </div>
    )
